...
En esta etapa el foco estuvo en extender el procesamiento más allá de los límites de un solo nodo, distribuyendo la carga de trabajo entre múltiples procesos independientes mediante MPI. A diferencia de OpenMP, en este modelo cada proceso (\textit{rank}) cuenta con su propio espacio de memoria privado, por lo que cualquier dato que un proceso necesite y no posea localmente debe ser explícitamente enviado y recibido a través de la red.
